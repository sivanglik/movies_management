...
router.route('/signin').
            ...
            const {Username,Password,SessionTimeOut,Permissions} = req.body;
             ...
             if(!user){
                  ...
                  let accessToken = jwt.sign({username:Username},"mysecret",
                     {expiresIn:7200})
               resp.json({
                  token:accessToken ,user:[{Permissions}], auth:true
               })
             }
             else{
